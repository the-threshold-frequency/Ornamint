...
<body>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-8 offset-lg-2  wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
          <form id="search" action="signup.php" method="post">
            <div class="col" style="margin-left: 32%; line-height: 2px; width:100%;">
               <div class="col-lg-4 col-sm-4">
                    <fieldset>
                      <label for="first_name"></label>
                      <input type="name" name="first_name" id="first_name"class="name" placeholder="First Name" autocomplete="on" required>
                    </fieldset>
                </div>
                <div class="col-lg-4 col-sm-4">
                    <fieldset>
                      <label for="last_name"></label>
                      <input type="name" name="last_name" class="name" placeholder="Last Name" autocomplete="on" required>
                    </fieldset>
                </div>
              <div class="col-lg-4 col-sm-4">
                <fieldset>
                  <label for="mail"></label>
                  <input type="email" name="mail" id="mail" class="website" placeholder="Email" autocomplete="on" required>
                </fieldset>
              </div>
              <div class="col-lg-4 col-sm-4">
                <fieldset>
                  <label for="password"></label>
                  <input type="password" name="password" id="password" class="email" placeholder="Password" autocomplete="on" required>
                </fieldset>
              </div>
              <div class="col-lg-4 col-sm-4">
                <fieldset>
                  <label for="confirm-password"></label>
                  <input type="password" name="confirm_password" id="confirm_password" class="email" placeholder="Confirm Password" autocomplete="on" required>
                </fieldset>
              </div>
              <div class="col-lg-4 col-sm-4" style="margin-top: 15px;">
                <fieldset>
                  <button type="submit" name="signup" class="main-button">SIGN UP</button>
  ...
  <footer>
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <p>Copyright © 2023 Ornamint Co., Ltd. All Rights Reserved. 
          </div>
      </div>
    </div>
  </footer>
