            ...
            <div class="col" style="margin-left: 32%; line-height: 2px; width:100%;">
              <div class="col-lg-4 col-sm-4">
                <fieldset>
                  ...
                  <input type="email" name="mail" id="mail" class="website" placeholder="Email" autocomplete="on">
                </fieldset>
              </div>
              <div class="col-lg-4 col-sm-4">
                <fieldset>
                  <label for="password"></label>
                  <input type="password" name="password" id="password" class="email" placeholder="Password" autocomplete="on">
                </fieldset>
              </div>
              ...
              <div class="col-lg-4 col-sm-4" style="margin-top: 15px;">
                <fieldset>
                  <button type="submit" class="main-button"><a href="./forgotpass.html" style="color: white;">Forgot Password</a></button>
                </fieldset>
              </div>
              <div class="col-lg-4 col-sm-4" style="margin-top: 15px;">
                <fieldset>
                  <button type="submit" class="main-button"><a href="./sign.php" style="color: white;">Signup</a></button>
                </fieldset>
              </div>
            </div>
          </form>
