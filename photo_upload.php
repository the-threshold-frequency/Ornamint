        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <a href="index.html" class="logo">
              <img src="assets/images/logo_ornamint.png" style="width: 50%;" alt="">
            </a>
            <!-- ** Logo End ** -->
            <!-- ** Menu Start ** -->
            <ul class="nav">
              ...
              <li class="scroll-to-section"><div class="border-first-button"><a href="uploadform.html">Back</a></div></li> 
            </ul>        
